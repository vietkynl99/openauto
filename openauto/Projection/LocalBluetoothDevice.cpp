...
{
    LOG(debug) << "onStartPairing, address: " << address.toStdString();
...
{
    LOG(debug) << "onPairingDisplayConfirmation, address: " << address.toString().toStdString()
                           << ", pin: " << pin.toStdString();
...
{
    LOG(debug) << "onPairingDisplayPinCode, address: " << address.toString().toStdString()
                           << ", pin: " << pin.toStdString();
